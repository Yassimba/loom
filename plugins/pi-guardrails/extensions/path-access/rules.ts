...
import { checkPathAccess, normalizeForDisplay, type PathAccessState } from "../../src/core/paths";
...
export function createPathAccessRule(state: PathAccessState): Rule<PathAccessMeta> {
  return {
