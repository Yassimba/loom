import { FuzzySelector, type SettingsTheme, Wizard } from "@aliou/pi-utils-settings";
import { type Component, Input, type SettingsListTheme } from "@earendil-works/pi-tui";
...
class PolicyProtectionStep implements Component {
  ...
  constructor(theme: SettingsListTheme, state: NewPolicyDraft, onComplete: () => void) {
