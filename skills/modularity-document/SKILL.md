...
**You MUST read the template file before generating HTML.** The template is at `assets/template.html` relative to this skill directory. Read this file, then replace:
