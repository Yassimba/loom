#!/usr/bin/env python3
# Vendored from https://github.com/cathrynlavery/diagram-design (MIT), v2.6.7.
...
Usage:
    python3 verify-geometry.py diagrams/*.html
    (copied from cathrynlavery/diagram-design scripts/verify-geometry.py)
"""
